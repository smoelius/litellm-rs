...
impl AnthropicModelRegistry {
    ...
    fn initialize_models(&mut self) {
        ...
        // Claude 3 Opus
        self.register_model("claude-3-opus-20240229", ModelSpec {
            model_info: ModelInfo {
        ...
        // Claude 3 Sonnet
        self.register_model("claude-3-sonnet-20240229", ModelSpec {
            model_info: ModelInfo {
        ...
        // Claude 3 Haiku
        self.register_model("claude-3-haiku-20240307", ModelSpec {
            model_info: ModelInfo {
        ...
        // Claude 2.1
        self.register_model("claude-2.1", ModelSpec {
            model_info: ModelInfo {
        ...
        // Claude Instant
        self.register_model("claude-instant-1.2", ModelSpec {
            model_info: ModelInfo {
