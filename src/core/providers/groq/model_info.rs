...
static MODEL_CONFIGS: LazyLock<HashMap<&'static str, ModelInfo>> = LazyLock::new(|| {
    ...
    // Llama 3.3 models
    configs.insert("llama-3.3-70b-versatile", ModelInfo {
    ...
    // Llama 3.2 models
    configs.insert("llama-3.2-90b-text-preview", ModelInfo {
    ...
    configs.insert("llama-3.2-11b-text-preview", ModelInfo {
    ...
    // Llama 3.1 models
    configs.insert("llama-3.1-405b-reasoning", ModelInfo {
    ...
    configs.insert("llama-3.1-70b-versatile", ModelInfo {
    ...
    configs.insert("llama-3.1-8b-instant", ModelInfo {
    ...
    // Mixtral
    configs.insert("mixtral-8x7b-32768", ModelInfo {
    ...
    // Gemma models
    configs.insert("gemma2-9b-it", ModelInfo {
    ...
    configs.insert("llama3-groq-70b-8192-tool-use-preview", ModelInfo {
    ...
    configs.insert("llama3-groq-8b-8192-tool-use-preview", ModelInfo {
    ...
    // Audio models
    configs.insert("whisper-large-v3", ModelInfo {
    ...
    configs.insert("whisper-large-v3-turbo", ModelInfo {
    ...
    configs.insert("distil-whisper-large-v3-en", ModelInfo {
    ...
    configs.insert("deepseek-r1-distill-llama-70b", ModelInfo {
    ...
    configs.insert("qwen3-32b", ModelInfo {
        model_id: "qwen3-32b",
    ...
    configs.insert("gpt-oss-20b", ModelInfo {
    ...
    configs.insert("gpt-oss-120b", ModelInfo {
