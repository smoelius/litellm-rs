...
impl AzureAIConfig {
    ...
    pub fn build_endpoint_url(&self, path: &str) -> Result<String, String> {
        let base_url = self.base.api_base
            .as_ref()
...
mod tests {
    ...
    fn test_endpoint_types() {
        assert_eq!(AzureAIEndpointType::ChatCompletions.as_path(), "chat/completions");
        assert_eq!(AzureAIEndpointType::Embeddings.as_path(), "embeddings");
        assert_eq!(AzureAIEndpointType::ImageGeneration.as_path(), "images/generations");
